...
const translations: Record<Language, TranslationMap> = {
  en: {
    ...
    'Existing Custom Hours': 'Existing Custom Hours',
    'No custom hours': 'No custom hours',
    'No reason provided': 'No reason provided',
    'Positive for bonus hours, negative for deduction': 'Positive for bonus hours, negative for deduction',
    'Reason': 'Reason',
    'All time': 'All time',
  ...
  he: {
    ...
    'Add Custom Hours': 'הוסף שעות מותאמות',
    'Existing Custom Hours': 'שעות מותאמות קיימות',
    'No custom hours': 'אין שעות מותאמות',
    'No reason provided': 'לא צוין סיבה',
    'Positive for bonus hours, negative for deduction': 'חיובי לשעות בונוס, שלילי לניכוי',
    'Reason': 'סיבה',
    'All time': 'כל הזמנים',
